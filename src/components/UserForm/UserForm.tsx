      ...
      <form onSubmit={onFormSubmit}>
        ...
        <div className="card-body">
          ...
          <div className="mb-3">
            ...
            <input type="text" className="form-control" id="name" name={'name'} value={user.name} onChange={changeUser}
                   placeholder="Jack Daniels" required/>
          </div>
          ...
          <div className="form-check form-switch mb-3">
            ...
            <input type="checkbox" className="form-check-input" id="isActive" name={'isActive'} checked={user.isActive} onChange={changeIsActive}
                   role="switch"/>
          </div>

          <select className="form-select" defaultValue={''} name={'role'} value={user.role} onChange={changeUser}
                  required>
